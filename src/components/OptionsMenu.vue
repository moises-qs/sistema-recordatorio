      ...
      <Transition name="dropdown">
         <div v-if="isOpen" v-click-outside="closeMenu"
            ...
            <div class="py-1">
               ...
               <button @click="handleClearCompleted" :disabled="stats.completed === 0"
               ...
               <button @click="handleRequestNotifications" v-if="showNotificationOption"
                  ...
                  <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                     <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                        d="M15 17h5l-5 5v-5zM12 2a7 7 0 017 7c0 5.25-3 7.5-5.25 11h-3.5C8 16.5 5 14.25 5 9a7 7 0 017-7z" />
                  </svg>
